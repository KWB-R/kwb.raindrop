...
system.time(
simulation_results <- kwb.raindrop::get_simulation_results_optim_parallel(paths = paths, 
                                                                 path_list = path_list,
...
pdff <- "simulation_results_optimisation_design-space_mulde-area_vs_mulde-height_single.pdf"
...
grDevices::pdf(file = pdff, width = 12, height = 8)
print(p)
dev.off()
