...
- New vignette `example_wien_minimal`: a self-contained smoke test of
  ...
  Daniel’s reference geometry (12 scenarios total). After Daniel’s XLSX
  ...
  `Mulde_Rigole/Eigenschaften_Oberflaeche/EvapPond = 0` (no open-water
  ET while the grass is submerged), and
