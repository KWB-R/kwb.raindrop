...
`>5` = rot, Legende oben). Mouseover zeigt den Wasserhaushalt
...
überlagert mit den Szenarien als Punkte. Je Box ist ein **bestes** Szenario
als Raute in der jeweiligen Gruppenfarbe (schwarz umrandet) markiert; die
Markierungen **aller** Klassen sind zur Frontier-Linie verbunden.
