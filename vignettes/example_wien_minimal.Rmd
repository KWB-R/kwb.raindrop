...
# Attach construction-cost columns (storage layer assumed Sickerbox; switch to
# Schotterrigol via storage_type = "Schotterrigol" or a per-row storage_type
# column in param_grid).
...
Switching the storage layer between **Sickerbox** (≈ 95 % porosity,
350 EUR/m³) and **Schotterrigol** (≈ 30 % porosity, 50 EUR/m³) trades
storage volume against cost; pass `storage_type = "Schotterrigol"` to
