...
path_list <- list(
  ...
  dir_output = "<root_path>/Optimierungsfall/models/120min_40mm/output", 
...
filter_height <- 300
storage_height <- seq(100, 500, 1000)
rain_factor <- 1
...
#> Rows with exactly one differing parameter: 7 of 36
#> Single-parameter variations per parameter: connected_area=0, mulde_area=3, mulde_height=2, filter_hydraulicconductivity=2, filter_height=0, storage_height=0, bottom_hydraulicconductivity=0, rain_factor=0
...
vals$`//Massnahmenelemente/Dach/Berechnungsparameter/Evapotranspiration_aktiv`
