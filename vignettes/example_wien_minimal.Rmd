...
unconditionally on every row, after Michael's review of the XLSX
...
run_one <- function(i, timestep_hours, debug = FALSE, ...) {
  ...
  # case study; leaving Dach/Evapotranspiration_aktiv at 1 (the base.h5
  # default) silently activated all the vegetation-ET parameters on the
  # roof, which is physically wrong.
